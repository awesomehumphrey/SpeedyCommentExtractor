...
class test_app(unittest.TestCase):
    ...
    def test_extract_comment_from_html(self):
        comments = [{'line': '<!-- hello -->', 'location': 'random', 'language': app.html_comment['language']}]
    ...
    def test_extract_comment_from_css(self):
        comments = [{'line': '/* hello */', 'location': 'random', 'language': app.css_comment['language']}]
    ...
    def test_extract_multiline_comment_from_html(self):
        comments = [
            {'line': '<!-- hello -->', 'location': 'random', 'language': app.html_comment['language']},
            {'line': 'hello', 'location': 'random', 'language': app.html_comment['language']},
            {'line': '-->', 'location': 'random', 'language': app.html_comment['language']},
                    ]
        test_case = app.extract_comment_from_line_list(comments, app.html_comment)
        result = app.strip_comment_of_symbols(test_case[0]['line'], app.html_comment)
        result = app.remove_starting_whitespace(result)
    ...
    def test_extract_multiline_comment_from_css(self):
        comments = [
            {'line': '/*', 'location': 'random', 'language': app.css_comment['language']},
            {'line': 'hello', 'location': 'random', 'language': app.css_comment['language']},
            {'line': '*/', 'location': 'random', 'language': app.css_comment['language']},
        ]
        test_case = app.extract_comment_from_line_list(comments, app.css_comment)
        result = app.strip_comment_of_symbols(test_case[0]['line'], app.css_comment)
    ...
    def test_check_trigger_none_multiline_comment_from_html(self):
        comments = [
            {'line': '<body>', 'location': 'random', 'language': app.html_comment['language']},
            {'line': '<p id="testcontent">page content: video player</p>', 'location': 'random', 'language': app.html_comment['language']},
            {'line': '<div id="video-container">', 'location': 'random', 'language': app.html_comment['language']},
                    ]
        self.assertFalse(app.check_triggers_multiline_comment(comments[0]['line'], app.html_comment['multiline_start'], app.html_comment['multiline_end']))


    def test_extract_none_multiline_comment_from_html(self):
        comments = [
            {'line': '<body>', 'location': 'random', 'language': app.html_comment['language']},
            {'line': '<p id="testcontent">page content: video player</p>', 'location': 'random', 'language': app.html_comment['language']},
            {'line': '<div id="video-container">', 'location': 'random', 'language': app.html_comment['language']},
